...
The [`BuildingData`](building-data.md) asset is the fundamental definition of a building in the system. Each building in your game should have a corresponding BuildingData asset that defines its properties, costs, and behaviors.

### Core Properties

| Property | Type | Description |
|----------|------|-------------|
| `buildingTags` | [`BuildingTags`](building-tags.md) | Category flags used for filtering and organization |
| `buildingType` | [`BuildingType`](building-type.md) | Functional classification of the building |
| `buildingName` | string | Display name shown in UI |
| `prefab` | [`BuildingInstance`](runtime/building-instance.md) | Prefab instantiated when building is placed |
...
| `nextLevelData` | [`BuildingData`](building-data.md) | Reference to next level's data asset |

### Connection Properties

| Property | Type | Description |
|----------|------|-------------|
| `connectionData` | [`BuildingConnectionData`](building-connection-data.md) | Optional configuration for neighbor connections |
...
The [`BuildingDatabaseSO`](building-database.md) asset serves as the central catalog of all available buildings in your project. It provides efficient runtime queries for filtering buildings by category and type.
...
The [`BuildingTags`](building-tags.md) enum uses the `[Flags]` attribute to provide a bitwise category system. This allows buildings to belong to multiple categories simultaneously.
...
The [`BuildingCategory`](building-category.md) asset provides optional UI organization for buildings. Unlike `BuildingTags` which are for gameplay logic, categories are primarily for organizing the building selection UI.

### Properties

| Property | Type | Description |
|----------|------|-------------|
| `buildingType` | [`BuildingType`](building-type.md) | Type classification |
...
The [`GridBuilderDefaults`](grid-builder-defaults.md) asset contains global settings and default prefabs used by editor tools to set up building instances automatically.

### Scene References

| Property | Type | Description |
|----------|------|-------------|
| `buildingManager` | [`BuildingManager`](architecture/building-manager.md) | Default building manager reference |
| `defaultGridManager` | [`GridManager`](architecture/grid-manager.md) | Default grid manager reference |
| `economyManager` | [`EconomyManager`](economy/overview.md) | Economy system manager |
| `buildingManagerUI` | [`BuildingManagerUI`](ui/building-manager-ui.md) | UI manager reference |
...
| Topic | Description |
|-------|-------------|
| [BuildingData](building-data.md) | Detailed BuildingData API reference |
| [BuildingDatabaseSO](building-database.md) | Database management and queries |
| [BuildingTags](building-tags.md) | Category enumeration reference |
| [BuildingCategory](building-category.md) | UI category organization |
| [GridBuilderDefaults](grid-builder-defaults.md) | Default settings configuration |
| [Economy System](economy/overview.md) | Resource and economy integration |
| [Runtime Building Instance](runtime/building-instance.md) | Building instance component |
