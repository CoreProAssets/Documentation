...
{
    public class BuildingUpgradeSystem : MonoBehaviourCorePro
    {
...
| [BuildingData](../data/building-data.md) | Building definition with upgrade path |
| [BuildingInstance](../runtime/building-instance.md) | Building instance component |
