...
{
    public class BuildingModeRepair : MonoBehaviourCorePro, IBuildingMode
    {
...
| [BuildingData](../data/building-data.md) | Building definition with repair costs |
| [Health System](../health/overview.md) | Building health management |
