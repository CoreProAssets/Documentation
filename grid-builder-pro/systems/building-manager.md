...
namespace CorePro.GridBuilderPro
{
    ...
    public class BuildingManager : SingletonScene<BuildingManager>
    {
...
protected override void Awake()
{
    ...
    blackboard = BuildingSystemBlackboardSO.Instance;
    buildingManagerUI ??= BuildingManagerUI.Instance;
    ...
    // Initialize systems
    buildingInputSystem.Init();
    modeBuild.Init();
    modeSell.Init(this);
    modeRepair.Init(this);
...
| [BuildingModeBuild](building-mode-build.md) | Build mode implementation |
| [BuildingModeSell](building-mode-sell.md) | Sell mode implementation |
| [BuildingModeRepair](building-mode-repair.md) | Repair mode implementation |
| [BuildingPreviewSystem](building-preview-system.md) | Preview visualization |
| [BuildingConstructionSystem](building-construction-system.md) | Construction timers |
| [BuildingUpgradeSystem](building-upgrade-system.md) | Building upgrades |
