...
{
    public class BuildingPreviewSystem : MonoBehaviourCorePro
    {
...
| [BuildingModeBuild](building-mode-build.md) | Build mode integration |
| [GridManager](../architecture/grid-manager.md) | Grid coordinate system |
| [PoolManager](../pooling/overview.md) | Object pooling system |
| [CellData](../data/cell-data.md) | Cell data structure |
